...
class DisplayHavingProductQrCode extends StatefulWidget {
  const DisplayHavingProductQrCode({super.key});

  @override
  State<DisplayHavingProductQrCode> createState() => _DisplayCartState();
}
...
class _DisplayCartState extends State<DisplayHavingProductQrCode> {
  ...
  Widget disPlayCarts() {
    ...
    return (watchScannerProduct.resultQrCode != null)
        ? Container(
            color: Colors.white,
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Bạn đang có 3 sản phẩm trong giỏ hàng',
